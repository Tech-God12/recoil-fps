...
import { buildM4, buildAK47, buildSCARH, buildM7Spear } from './rifles';
...
export { buildM4, buildAK47, buildSCARH, buildM7Spear, buildM1911, buildDeagle, buildMP7, buildVector, buildAWM, buildSPAS12, buildM249 };
export const WEAPON_BUILDERS: Record<WeaponId, () => WeaponModel> = {
  ...
  scar_h: buildSCARH, m7_spear: buildM7Spear, vector: buildVector, spas12: buildSPAS12, deagle: buildDeagle, m249: buildM249,
};
