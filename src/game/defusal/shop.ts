...
export const SHOP: ShopItem[] = [
  ...
  { id: 'm7_spear', name: 'M7 SPEAR', category: 'rifles', price: 3600, kind: 'primary', weapon: 'm7_spear', killClass: 'rifle', tag: '6.8mm piston rifle · long lane control' },
...
export const BALLISTICS: Record<WeaponId, Ballistics> = {
  ...
  m7_spear: { damage: 42, armorRatio: 0.89 },
