...
export { WEAPON_BUILDERS, buildM4, buildAK47, buildM1911, buildAWM, buildMP7, buildSCARH, buildMCXSpear, buildVector, buildSPAS12, buildDeagle, buildM249 } from './weapons/index';
