...
export const SHOP: ShopItem[] = [
  ...
  { id: 'mcx_spear', name: 'MCX Spear', category: 'rifles', price: 3900, kind: 'primary', weapon: 'mcx_spear', killClass: 'rifle', tag: 'Full-power 6.8 · defeats armor at range' },
...
export const BALLISTICS: Record<WeaponId, Ballistics> = {
  ...
  mcx_spear: { damage: 38, armorRatio: 0.82 },
