...
test('competent first run pays ≈ $3,350 and the expanded armory remains a 15–20 run unlock', () => {
  ...
  assert.ok(catalogValue >= 55000 && catalogValue <= 67000, `catalog worth $${catalogValue}`);
