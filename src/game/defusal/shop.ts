...
export const SHOP: ShopItem[] = [
  ...
  { id: 'spear', name: 'MCX-SPEAR', category: 'rifles', price: 4200, kind: 'primary', weapon: 'spear', killClass: 'rifle', tag: 'Piston battle rifle · 20-round precision' },
...
export const BALLISTICS: Record<WeaponId, Ballistics> = {
  ...
  spear: { damage: 43, armorRatio: 0.89 },
