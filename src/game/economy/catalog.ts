...
export const WEAPON_CATALOG: WeaponCatalogEntry[] = [
  ...
  },
  {
    ...
    blurb: 'Sidearm firestorm. 900 RPM of 4.6mm for room-clearing when your primary is empty — climbs if you hold the trigger.',
...
export const ATTACHMENT_CATALOG: AttachmentCatalogEntry[] = [
  ...
  // ---------------- OPTIC ----------------
  // Every optic declares its true magnification in `zoom`; the engine converts that to
  // a real FOV pull (PUBG-style). 1x dots, 2x/3x/4x/6x mid-range glass, 8-12x sniper
  // tubes. Every primary weapon mounts the whole lineup.
  {
    id: 'opt_reddot', slot: 'optic', name: 'Red Dot Sight', price: 450, tier: 1,
    compat: ['m4a1', 'ak47', 'scar_h', 'vector', 'mp7', 'spas12', 'm249', 'awm'],
    desc: 'Single glowing dot, both eyes open. Snaps onto target faster than irons — a whisker of zoom, no excuses.',
    pros: ['Clean dot reticle', 'Faster ADS'],
    cons: ['1x only'],
    mods: { scopeReticle: 'dot', adsTimeMul: 0.95, zoom: 1.3 },
    visual: 'reddot',
  },
  {
    ...
    cons: ['1x only'],
    mods: { scopeReticle: 'holo', adsTimeMul: 0.97, hipSpreadMul: 0.95, zoom: 1.3 },
    visual: 'holo',
  },
  {
    id: 'opt_2x', slot: 'optic', name: '2x Aimpoint', price: 800, tier: 2,
    compat: ['m4a1', 'ak47', 'scar_h', 'vector', 'mp7', 'spas12', 'm249', 'awm'],
    desc: 'Compact 2x prism in a short tube. Doubles your reach without giving up the room — the doorway optic.',
    pros: ['2x magnification', 'Forgiving eye relief'],
    cons: ['Soft past 100 m'],
    mods: { scopeReticle: 'x2', adsTimeMul: 1.06, zoom: 2 },
    visual: 'scope_2x',
  },
  {
    id: 'opt_3x', slot: 'optic', name: '3x Specter', price: 1100, tier: 2,
    compat: ['m4a1', 'ak47', 'scar_h', 'vector', 'mp7', 'spas12', 'm249', 'awm'],
    desc: '3x battle sight with a circle-dot glass. The mid-range bridge: still quick at the shoulder, honest at 150 m.',
    pros: ['3x magnification', 'Circle-dot reticle'],
    cons: ['Slower ADS'],
    mods: { scopeReticle: 'x3', adsTimeMul: 1.12, zoom: 3 },
    visual: 'scope_3x',
  },
  {
    id: 'opt_acog', slot: 'optic', name: '4x ACOG Scope', price: 1400, tier: 3,
    compat: ['m4a1', 'ak47', 'scar_h', 'vector', 'mp7', 'spas12', 'm249', 'awm'],
    desc: 'Fixed 4x chevron with bullet-drop ticks. Turns mid-range into your personal range day — tunnel vision included.',
    pros: ['4x magnification', '+10 m effective range'],
    cons: ['Slower ADS', 'Poor up close'],
    mods: { scopeReticle: 'acog', adsTimeMul: 1.2, falloffStartAdd: 10, zoom: 4 },
    visual: 'acog',
  },
  {
    id: 'opt_6x', slot: 'optic', name: '6x Marksman Scope', price: 1800, tier: 3,
    compat: ['m4a1', 'ak47', 'scar_h', 'vector', 'mp7', 'spas12', 'm249', 'awm'],
    desc: 'Long 6x tube with mil-dot glass. Everything inside 200 m is a bench rest — anything closer is a club.',
    pros: ['6x magnification', 'Mil-dot holdovers'],
    cons: ['Much slower ADS', 'Very poor up close'],
    mods: { scopeReticle: 'x6', adsTimeMul: 1.28, swayMul: 0.92, zoom: 6 },
    visual: 'scope_6x',
  },
  {
    id: 'opt_hybrid', slot: 'optic', name: 'Hybrid Sight', price: 2100, tier: 3,
    compat: ['m4a1', 'ak47', 'scar_h', 'vector', 'mp7'],
    desc: 'Low-power variable with true 1x. Tap V while scoped to swing between dot speed and 6x reach.',
    pros: ['1.5x / 6x on demand (V)', 'Chevron reticle'],
    cons: ['Slower ADS', 'Heavy glass'],
    mods: { scopeReticle: 'acog', adsTimeMul: 1.1, lpvo: true, zoom: 1.5 },
    visual: 'lpvo',
  },
  {
    id: 'opt_sniper_hp', slot: 'optic', name: 'Sniper Scope', price: 1650, tier: 3,
    compat: ['awm'],
    desc: 'Replaces the factory 8x with a 12x precision tube. Steadier glass for prone-quality shots from a crouch.',
    pros: ['12x magnification', 'Steadier when crouched'],
    cons: ['Useless inside 20 m'],
    mods: { scopeReticle: 'sniper', swayMulCrouched: 0.7, zoom: 12 },
    visual: 'scope_hp',
  },
  {
    ...
    cons: ['1x only'],
    mods: { scopeReticle: 'dot', adsTimeMul: 0.92, zoom: 1.25 },
    visual: 'pistol_rmr',
  },
