...
import { buildM4, buildAK47, buildSCARH, buildMCXSpear } from './rifles';
...
export { buildM4, buildAK47, buildSCARH, buildMCXSpear, buildM1911, buildDeagle, buildMP7, buildVector, buildAWM, buildSPAS12, buildM249 };
export const WEAPON_BUILDERS: Record<WeaponId, () => WeaponModel> = {
  ...
  scar_h: buildSCARH, mcx_spear: buildMCXSpear, vector: buildVector, spas12: buildSPAS12, deagle: buildDeagle, m249: buildM249,
};
