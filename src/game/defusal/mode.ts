...
export const BOT_WEAPONS: Record<WeaponId, BotWeapon> = {
  ...
  spear: { id: 'spear', name: 'SPEAR', kind: 'rifle', damage: 43, armorRatio: 0.89, interval: 0.092, burst: [2, 5], pause: [0.32, 0.58], accNear: 0.82, accFar: 0.54, range: 68, headChance: 0.12 },
...
const WORLD_KIND: Record<WeaponId, WorldWeaponKind> = {
  ...
  scar_h: 'rifle', spear: 'rifle', awm: 'sniper', spas12: 'shotgun', m249: 'lmg',
};
