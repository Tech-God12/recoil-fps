...
export class WeaponAssembly {
  ...
  finish(options: {
    ...
    const ids: Record<string, string> = { M416:'m4a1','AK-47':'ak47','M1911 A1':'m1911',AWM:'awm',MP7:'mp7','SCAR-H':'scar_h','MCX-SPEAR':'spear','KRISS Vector':'vector','SPAS-12':'spas12','Desert Eagle':'deagle','M249 SAW':'m249' };
