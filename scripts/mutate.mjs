...
const mutationTests = mutation => {
  ...
  if (mutation.file === 'src/game/defusal/rules.ts') return ['tests/defusal-rules.test.js'];
  if (mutation.file === 'src/game/defusal/shop.ts') return ['tests/defusal-shop.test.js'];
  if (mutation.file === 'src/game/defusal/mode.ts') return ['tests/defusal-mode.test.js'];
