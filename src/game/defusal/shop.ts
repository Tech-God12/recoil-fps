...
export const SHOP: ShopItem[] = [
  ...
  { id: 'mcx_spear', name: 'MCX-SPEAR', category: 'rifles', price: 3600, kind: 'primary', weapon: 'mcx_spear', killClass: 'rifle', tag: '6.8mm piston rifle · long lane control' },
...
export const BALLISTICS: Record<WeaponId, Ballistics> = {
  ...
  mcx_spear: { damage: 42, armorRatio: 0.89 },
