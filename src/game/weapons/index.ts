...
import { buildM4, buildAK47, buildSCARH } from './rifles';
...
import { buildMCXSpear } from './spear';

export { buildM4, buildAK47, buildSCARH, buildM1911, buildDeagle, buildMP7, buildVector, buildAWM, buildSPAS12, buildM249, buildMCXSpear };
export const WEAPON_BUILDERS: Record<WeaponId, () => WeaponModel> = {
  ...
  scar_h: buildSCARH, vector: buildVector, spas12: buildSPAS12, deagle: buildDeagle, m249: buildM249,
  mcx_spear: buildMCXSpear,
};
